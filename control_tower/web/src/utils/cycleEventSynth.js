...
const WATCHDOG_KIND_TO_PHRASE = {
  ...
  // Agent Supervisor (Product Director) — same channel as the orchestrator.
  supervisor_review_started:             "Agent Supervisor review started",
  supervisor_review_completed:           "Agent Supervisor review completed",
  supervisor_review_failed:              "Agent Supervisor review failed",
  supervisor_pass:                       "Agent accountability passed",
  supervisor_fail:                       "Agent accountability failed",
  supervisor_meaningful_missing:         "Meaningful change missing",
  supervisor_ticket_missing:             "Implementation Ticket missing",
  supervisor_cycle_blocked:              "Cycle blocked by agent",
  supervisor_planner_rejected:           "Planner rejected",
  supervisor_designer_rejected:          "Designer rejected",
  supervisor_pm_rejected:                "PM rejected",
  supervisor_frontend_rejected:          "Frontend rejected",
  supervisor_backend_rejected:           "Backend rejected",
  supervisor_ai_rejected:                "AI rejected",
